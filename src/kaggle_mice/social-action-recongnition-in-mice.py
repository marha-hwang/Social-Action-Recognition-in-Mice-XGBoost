...
dataset_path = "/Users/haram/Desktop/카카오부캠/코드/kaggle-mice/kaggle-mice/src/kaggle/input/MABe-mouse-behavior-detection"

# %%
class CFG:
    train_path = f"{dataset_path}/train.csv"
    test_path = f"{dataset_path}/test.csv"
    train_annotation_path = f"{dataset_path}/train_annotation"
    train_tracking_path = f"{dataset_path}/train_tracking"
    test_tracking_path = f"{dataset_path}/test_tracking"
...
def generate_mouse_data(dataset, traintest, traintest_directory=None, generate_single=True, generate_pair=True):
    if traintest_directory is None:
        traintest_directory = f"{dataset_path}/{traintest}_tracking"
